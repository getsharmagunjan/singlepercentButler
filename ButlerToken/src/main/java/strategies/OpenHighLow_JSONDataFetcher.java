...
public class OpenHighLow_JSONDataFetcher implements AutoCloseable 
{
	private Logger butlog;
	//private OkHttpClient client;
	//private Request request;
	//private Response response;
	private final String nifty50_old_url;
	private final String nifty50_new_url;
	private final String nifty100_old_url;
	private final String nifty100_new_url;
	private final String nifty50_old_json_data_file_path;
	private final String nifty50_new_json_data_file_path;
	private final String nifty100_old_json_data_file_path;
	private final String nifty100_new_json_data_file_path;
	private final String nifty_old_host;
	private final String nifty_new_host;
	...
	private void fetchJSONDataPrivately(String url, String file, String host) throws Exception
	{
		...
		Request request=new Request.Builder()
				 ...
				 // .header("Host", host) //removed host, if required, add it again, commenting out code related to host.
				  ...
				  .header("User-Agent", "PostmanRuntime/7.24.1") //NSE checks User-Agent, so if you change/remove it will not work. if you want to change, change to "Tasker/5.9.3.beta.4 (Android/9)" never use chrome, safari etc, as they know from where you are surfing.
				  .build(); 
	...
	{
		OpenHighLow_JSONDataFetcher obj=new OpenHighLow_JSONDataFetcher();
