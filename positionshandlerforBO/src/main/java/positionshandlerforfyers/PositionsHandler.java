...
public class PositionsHandler implements AutoCloseable 
{
	...
	private PendingPositionsHandler pendingPositionsHandler;
	int counter;
	...
	PositionsHandler()
	{
		...
		this.pendingPositionsHandler=new PendingPositionsHandler();
	}
	public void close()
	{
		this.size=0;
		...
		this.get_orders_url=null;
		this.restconnection.close();
		this.pendingPositionsHandler=null;
		this.butlog.info("Closing Positions Resources");
		this.butlog=null;
		System.gc();
		System.exit(0);
	...
	public void handlePositions()
	{
		...
		{
			this.totalPnL=this.totalPnL+this.pl.get(i);
		}
		this.totalPnL=Precision.round(this.totalPnL, 2);
		this.counter=this.gsheet.readCounterOfButlerBOPnLRecords("174Wd2Gc7SwhmL4iyXTANSY9iMd5N0Lp2Ia6RVq43sEU", "PnLRecords!Y3");
		this.butlog.info("Counter is = "+this.counter);
		Date date =Calendar.getInstance().getTime();
		DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy hh.mm aa");
		String DateTime = dateFormat.format(date);
		this.butlog.info("DateTime is = "+DateTime);
		double totalPnL =Double.parseDouble(Float.toString(this.totalPnL));
		this.butlog.info("Total PnL is = "+totalPnL);
		this.gsheet.updateButlerBOPnLRecords("174Wd2Gc7SwhmL4iyXTANSY9iMd5N0Lp2Ia6RVq43sEU", "PnLRecords!A"+this.counter, "PnLRecords!B"+this.counter, DateTime, totalPnL,"PnLRecords!Y3",this.counter+1);
		String decision=this.gsheet.readDecisionOfButlerBOPnLRecords("174Wd2Gc7SwhmL4iyXTANSY9iMd5N0Lp2Ia6RVq43sEU", "PnLRecords!E"+this.counter);
		this.butlog.warn("decision is = "+decision);
		if(decision.equalsIgnoreCase("true"))
		{
			this.pendingPositionsHandler.handlePendingPositions();
		}
	}
	private void handlePositionsPrivately()
	{
